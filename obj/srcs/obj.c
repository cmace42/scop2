...
/*   Updated: 2022/03/08 13:34:51 by cmace            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	printError(t_obj_reader self, int error)
{
	...
	else if (error == WRONG_VERTEX_TYPE_IN_FACE || error == WRONG_NORMAL_TYPE_IN_FACE)
		write(2, "Face can't have different type in faces\n", 41);
	return (error);
}
